...
{{/*
Create echo-server component name.
*/}}
{{- define "echo.server" -}}
{{- printf "%s-%s" .Chart.Name "server" | replace "+" "_" | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Create echo-client component name.
*/}}
{{- define "echo.client" -}}
{{- printf "%s-%s" .Chart.Name "client" | replace "+" "_" | trunc 63 | trimSuffix "-" }}
{{- end }}
